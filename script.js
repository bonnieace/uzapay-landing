document.addEventListener("DOMContentLoaded", () => {
  ...
  // Pill Nav interaction applied only to the existing right-side navigation links.
  const setupNavPills = () => {
    const items = [...document.querySelectorAll(".links .nav-pill")];
    ...
    items.forEach(item => {
      ...
      if (!href.includes("#waitlist") && href.startsWith("/") && normalized === currentPath) {
